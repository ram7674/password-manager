            ...
            <div className="app-container">
              <div className="responsive-container">
                <div className="app-header">
                  <img
                    src="images/password-manager-logo-img.png"
                    alt="app logo"
                    className="app-logo"
                  />
                </div>
                <div className="card-container manager-container">
                  <img
                    src="images/password-manager-sm-img.png"
                    ...
                    >
                      ...
                      <div className="input-container">
                        <div className="icon-container">
                          <img
                            ...
                            src="images\password-manager-website-img.png"
                            alt="website"
                          />
                        </div>
                      ...
                      <div className="input-container">
                        <div className="icon-container">
                          <img
                            className="input-icon"
                            src="/images/password-manager-username-img.png"
                            alt="username"
                          />
                        </div>
                        <input
                      ...
                      <div className="input-container">
                        <div className="icon-container">
                          <img
                            className="input-icon"
                            src="/images/password-manager-password-img.png"
                            alt="password"
                          />
                        </div>
                        <input
                  ...
                  <div className="card-responsive no-password-container">
                    <div className="passwords-header">
                      ...
                      <div className="search-container">
                        <div className="search-icon-container">
                          <img
                            src="/images/password-manager-search-img.png"
                            alt="search"
                    ...
                    {searchResults.length !== 0 ? (
                      ...
                      <div className="no-password-container">
                        <img
                          src="/images/no-passwords-img.png"
                          alt="no passwords"
